...
const promptIds = Object.keys(promptCatalog) as Array<keyof typeof promptCatalog>;
 ...
 */
promptRouter.post('/render', (req: Request, res: Response) => {
 ...
 */
promptRouter.post('/generate', async (req: Request, res: Response) => {
